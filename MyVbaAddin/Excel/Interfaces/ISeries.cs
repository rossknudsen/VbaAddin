	...
	public class ISeries : COMObject
	{
		...
		public NetOffice.ExcelApi.ErrorBars ErrorBars
		{
			get
			{
				...
				NetOffice.ExcelApi.ErrorBars newObject = NetOffice.Factory.CreateKnownObjectFromComProxy(this,returnItem,NetOffice.ExcelApi.ErrorBars.LateBindingApiWrapperType) as NetOffice.ExcelApi.ErrorBars;
				return newObject;
			}
		}
		...
		public NetOffice.ExcelApi.LeaderLines LeaderLines
		{
			get
			{
				...
				NetOffice.ExcelApi.LeaderLines newObject = NetOffice.Factory.CreateKnownObjectFromComProxy(this,returnItem,NetOffice.ExcelApi.LeaderLines.LateBindingApiWrapperType) as NetOffice.ExcelApi.LeaderLines;
				return newObject;
			}
		}
